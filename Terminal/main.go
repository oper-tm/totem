...
func main() {
	fmt.Println(tag, "Made by Oper - Totem 1.0.0 - 2026")
	...
	if strings.EqualFold(rType, "xnxx") {
		if !strings.EqualFold(arg3, "list") {
			err, m3u8Url = xnxx(arg3)
		} else {
			err, m3u8Url = xnxx("NULL")
		}
		
		if err != nil {
			return
		}
	} else if strings.EqualFold(rType, "twitch") {
